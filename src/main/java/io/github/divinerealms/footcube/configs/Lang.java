...
public enum Lang {
  ...
  TAKEPLACE_AVAILABLE_ENTRY("takeplace.available.entry", "&e- Match #{0} &7({1}) - &a{2} &7slots open"),
  ...
  SET_GOAL_CELEBRATION("set.goal-celebration", "{prefix}Postavili ste stil proslave gola na: &e{0}"),
